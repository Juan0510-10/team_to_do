...
export default function Home() {
  ...
  return (
    <main className="bg-black/30 p-6 sm:p-8 rounded-2xl shadow-md border border-gold/10">
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-4">
          <h1 className="text-2xl font-bold text-gold">Tus Tareas</h1>
          <SearchBar
            query={query}
            setQuery={setQuery}
            filter={filter}
        ...
        {loading ? (
          <div className="text-center p-6 text-gray-300">Cargando tareas...</div>
        ) : filtered.length === 0 ? (
